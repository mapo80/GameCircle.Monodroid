...
#pragma warning restore 0169
		...
		// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.ags.html5.content']/class[@name='ContentManager.UpgradeAction']"
		[global::Android.Runtime.Register ("com/amazon/ags/html5/content/ContentManager$UpgradeAction", DoNotGenerateAcw=true)]
		public sealed partial class UpgradeAction : global::Java.Lang.Enum {


			static IntPtr DEFAULT_UPGRADE_ACTION_jfieldId;

			// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.ags.html5.content']/class[@name='ContentManager.UpgradeAction']/field[@name='DEFAULT_UPGRADE_ACTION']"
			[Register ("DEFAULT_UPGRADE_ACTION")]
			public static global::Com.Amazon.Ags.Html5.Content.ContentManager.UpgradeAction DefaultUpgradeAction {
				get {
					if (DEFAULT_UPGRADE_ACTION_jfieldId == IntPtr.Zero)
						DEFAULT_UPGRADE_ACTION_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "DEFAULT_UPGRADE_ACTION", "Lcom/amazon/ags/html5/content/ContentManager$UpgradeAction;");
					IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, DEFAULT_UPGRADE_ACTION_jfieldId);
					return global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Html5.Content.ContentManager.UpgradeAction> (__ret, JniHandleOwnership.TransferLocalRef);
				}
				set {
					if (DEFAULT_UPGRADE_ACTION_jfieldId == IntPtr.Zero)
						DEFAULT_UPGRADE_ACTION_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "DEFAULT_UPGRADE_ACTION", "Lcom/amazon/ags/html5/content/ContentManager$UpgradeAction;");
					IntPtr native_value = JNIEnv.ToLocalJniHandle (value);
					JNIEnv.SetStaticField (class_ref, DEFAULT_UPGRADE_ACTION_jfieldId, native_value);
					JNIEnv.DeleteLocalRef (native_value);
				}
			}

			static IntPtr LOCAL_UPGRADE_ACTION_jfieldId;

			// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.ags.html5.content']/class[@name='ContentManager.UpgradeAction']/field[@name='LOCAL_UPGRADE_ACTION']"
			[Register ("LOCAL_UPGRADE_ACTION")]
			public static global::Com.Amazon.Ags.Html5.Content.ContentManager.UpgradeAction LocalUpgradeAction {
				get {
					if (LOCAL_UPGRADE_ACTION_jfieldId == IntPtr.Zero)
						LOCAL_UPGRADE_ACTION_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "LOCAL_UPGRADE_ACTION", "Lcom/amazon/ags/html5/content/ContentManager$UpgradeAction;");
					IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, LOCAL_UPGRADE_ACTION_jfieldId);
					return global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Html5.Content.ContentManager.UpgradeAction> (__ret, JniHandleOwnership.TransferLocalRef);
				}
				set {
					if (LOCAL_UPGRADE_ACTION_jfieldId == IntPtr.Zero)
						LOCAL_UPGRADE_ACTION_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "LOCAL_UPGRADE_ACTION", "Lcom/amazon/ags/html5/content/ContentManager$UpgradeAction;");
					IntPtr native_value = JNIEnv.ToLocalJniHandle (value);
					JNIEnv.SetStaticField (class_ref, LOCAL_UPGRADE_ACTION_jfieldId, native_value);
					JNIEnv.DeleteLocalRef (native_value);
				}
			}

			static IntPtr NO_UPGRADE_jfieldId;

			// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.ags.html5.content']/class[@name='ContentManager.UpgradeAction']/field[@name='NO_UPGRADE']"
			[Register ("NO_UPGRADE")]
			public static global::Com.Amazon.Ags.Html5.Content.ContentManager.UpgradeAction NoUpgrade {
				get {
					if (NO_UPGRADE_jfieldId == IntPtr.Zero)
						NO_UPGRADE_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "NO_UPGRADE", "Lcom/amazon/ags/html5/content/ContentManager$UpgradeAction;");
					IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, NO_UPGRADE_jfieldId);
					return global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Html5.Content.ContentManager.UpgradeAction> (__ret, JniHandleOwnership.TransferLocalRef);
				}
				set {
					if (NO_UPGRADE_jfieldId == IntPtr.Zero)
						NO_UPGRADE_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "NO_UPGRADE", "Lcom/amazon/ags/html5/content/ContentManager$UpgradeAction;");
					IntPtr native_value = JNIEnv.ToLocalJniHandle (value);
					JNIEnv.SetStaticField (class_ref, NO_UPGRADE_jfieldId, native_value);
					JNIEnv.DeleteLocalRef (native_value);
				}
			}
			...
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/amazon/ags/html5/content/ContentManager$UpgradeAction", ref java_class_handle);
				}
			}
			...
			protected override global::System.Type ThresholdType {
				get { return typeof (UpgradeAction); }
			}

			internal UpgradeAction (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}
