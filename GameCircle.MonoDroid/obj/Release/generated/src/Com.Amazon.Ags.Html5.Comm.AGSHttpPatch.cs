...
namespace Com.Amazon.Ags.Html5.Comm {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.ags.html5.comm']/class[@name='AGSHttpPatch']"
	[global::Android.Runtime.Register ("com/amazon/ags/html5/comm/AGSHttpPatch", DoNotGenerateAcw=true)]
	public partial class AGSHttpPatch : global::Com.Amazon.Ags.Html5.Comm.ServiceRequestBase {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/ags/html5/comm/AGSHttpPatch", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AGSHttpPatch); }
		}

		protected AGSHttpPatch (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Z;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.ags.html5.comm']/class[@name='AGSHttpPatch']/constructor[@name='AGSHttpPatch' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='boolean']]"
		[Register (".ctor", "(Ljava/lang/String;Z)V", "")]
		public AGSHttpPatch (string p0, bool p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			IntPtr native_p0 = JNIEnv.NewString (p0);;
			if (GetType () != typeof (AGSHttpPatch)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Ags.Html5.Comm.AGSHttpPatch __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Html5.Comm.AGSHttpPatch> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.PrepareHttpRequestBase ());
		}
#pragma warning restore 0169

		static IntPtr id_prepareHttpRequestBase;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.html5.comm']/class[@name='AGSHttpPatch']/method[@name='prepareHttpRequestBase' and count(parameter)=0]"
