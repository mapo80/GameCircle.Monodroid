...
namespace Com.Amazon.Ags.Html5.Comm {
	...
	public abstract partial class ServiceRequestBase : global::Java.Lang.Object {
		...
		static IntPtr requestBody_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.ags.html5.comm']/class[@name='ServiceRequestBase']/field[@name='requestBody']"
		[Register ("requestBody")]
		protected string RequestBody {
			get {
				if (requestBody_jfieldId == IntPtr.Zero)
					requestBody_jfieldId = JNIEnv.GetFieldID (class_ref, "requestBody", "Ljava/lang/String;");
				IntPtr __ret = JNIEnv.GetObjectField (Handle, requestBody_jfieldId);
			...
			set {
				...
				JNIEnv.SetField (Handle, requestBody_jfieldId, native_value);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.html5.comm']/class[@name='ServiceRequestBase']/method[@name='setRequestBody' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
