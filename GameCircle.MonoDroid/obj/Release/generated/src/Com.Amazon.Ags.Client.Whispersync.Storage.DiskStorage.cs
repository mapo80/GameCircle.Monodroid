...
#pragma warning restore 0169
		...
		static Delegate cb_writeDataToFile_Ljava_io_File_arrayB;
#pragma warning disable 0169
		static Delegate GetWriteDataToFile_Ljava_io_File_arrayBHandler ()
		{
			if (cb_writeDataToFile_Ljava_io_File_arrayB == null)
				cb_writeDataToFile_Ljava_io_File_arrayB = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr, IntPtr>) n_WriteDataToFile_Ljava_io_File_arrayB);
			return cb_writeDataToFile_Ljava_io_File_arrayB;
		}

		static void n_WriteDataToFile_Ljava_io_File_arrayB (IntPtr jnienv, IntPtr native__this, IntPtr native_p0, IntPtr native_p1)
		{
			global::Com.Amazon.Ags.Client.Whispersync.Storage.DiskStorage __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Client.Whispersync.Storage.DiskStorage> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			...
			__this.WriteDataToFile (p0, p1);
			if (p1 != null)
				JNIEnv.CopyArray (p1, native_p1);
		}
#pragma warning restore 0169

		static IntPtr id_writeDataToFile_Ljava_io_File_arrayB;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.storage']/class[@name='DiskStorage']/method[@name='writeDataToFile' and count(parameter)=2 and parameter[1][@type='java.io.File'] and parameter[2][@type='byte[]']]"
		[Register ("writeDataToFile", "(Ljava/io/File;[B)V", "GetWriteDataToFile_Ljava_io_File_arrayBHandler")]
		protected virtual void WriteDataToFile (global::Java.IO.File p0, byte[] p1)
		{
			if (id_writeDataToFile_Ljava_io_File_arrayB == IntPtr.Zero)
				id_writeDataToFile_Ljava_io_File_arrayB = JNIEnv.GetMethodID (class_ref, "writeDataToFile", "(Ljava/io/File;[B)V");
			IntPtr native_p1 = JNIEnv.NewArray (p1);

			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_writeDataToFile_Ljava_io_File_arrayB, new JValue (p0), new JValue (native_p1));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_writeDataToFile_Ljava_io_File_arrayB, new JValue (p0), new JValue (native_p1));
			if (p1 != null) {
