...
#pragma warning restore 0169
		...
		static IntPtr id_createVersionFromDefaultContentRawResource_Landroid_content_Context_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.html5.content']/class[@name='ContentVersion']/method[@name='createVersionFromDefaultContentRawResource' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String']]"
		[Register ("createVersionFromDefaultContentRawResource", "(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/amazon/ags/html5/content/ContentVersion;", "")]
		public static global::Com.Amazon.Ags.Html5.Content.ContentVersion CreateVersionFromDefaultContentRawResource (global::Android.Content.Context p0, string p1, string p2)
		{
			if (id_createVersionFromDefaultContentRawResource_Landroid_content_Context_Ljava_lang_String_Ljava_lang_String_ == IntPtr.Zero)
				id_createVersionFromDefaultContentRawResource_Landroid_content_Context_Ljava_lang_String_Ljava_lang_String_ = JNIEnv.GetStaticMethodID (class_ref, "createVersionFromDefaultContentRawResource", "(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/amazon/ags/html5/content/ContentVersion;");
			IntPtr native_p1 = JNIEnv.NewString (p1);
			IntPtr native_p2 = JNIEnv.NewString (p2);
			global::Com.Amazon.Ags.Html5.Content.ContentVersion __ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Html5.Content.ContentVersion> (JNIEnv.CallStaticObjectMethod  (class_ref, id_createVersionFromDefaultContentRawResource_Landroid_content_Context_Ljava_lang_String_Ljava_lang_String_, new JValue (p0), new JValue (native_p1), new JValue (native_p2)), JniHandleOwnership.TransferLocalRef);
		...
		static IntPtr id_createVersionFromZip_Ljava_util_zip_ZipFile_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.html5.content']/class[@name='ContentVersion']/method[@name='createVersionFromZip' and count(parameter)=1 and parameter[1][@type='java.util.zip.ZipFile']]"
		[Register ("createVersionFromZip", "(Ljava/util/zip/ZipFile;)Lcom/amazon/ags/html5/content/ContentVersion;", "")]
		public static global::Com.Amazon.Ags.Html5.Content.ContentVersion CreateVersionFromZip (global::Java.Util.Zip.ZipFile p0)
		{
			if (id_createVersionFromZip_Ljava_util_zip_ZipFile_ == IntPtr.Zero)
				id_createVersionFromZip_Ljava_util_zip_ZipFile_ = JNIEnv.GetStaticMethodID (class_ref, "createVersionFromZip", "(Ljava/util/zip/ZipFile;)Lcom/amazon/ags/html5/content/ContentVersion;");
			global::Com.Amazon.Ags.Html5.Content.ContentVersion __ret = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Html5.Content.ContentVersion> (JNIEnv.CallStaticObjectMethod  (class_ref, id_createVersionFromZip_Ljava_util_zip_ZipFile_, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
			return __ret;
		}
