...
namespace Com.Amazon.Ags.Html5.Util {
	...
	public partial class ResourceUtils : global::Java.Lang.Object {
		...
		static IntPtr id_getLayoutId_Landroid_content_Context_Ljava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.html5.util']/class[@name='ResourceUtils']/method[@name='getLayoutId' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.lang.String']]"
		[Register ("getLayoutId", "(Landroid/content/Context;Ljava/lang/String;)I", "")]
		public static int GetLayoutId (global::Android.Content.Context p0, string p1)
		{
			if (id_getLayoutId_Landroid_content_Context_Ljava_lang_String_ == IntPtr.Zero)
				id_getLayoutId_Landroid_content_Context_Ljava_lang_String_ = JNIEnv.GetStaticMethodID (class_ref, "getLayoutId", "(Landroid/content/Context;Ljava/lang/String;)I");
			IntPtr native_p1 = JNIEnv.NewString (p1);
			int __ret = JNIEnv.CallStaticIntMethod  (class_ref, id_getLayoutId_Landroid_content_Context_Ljava_lang_String_, new JValue (p0), new JValue (native_p1));
			JNIEnv.DeleteLocalRef (native_p1);
			return __ret;
		}
