...
namespace Com.Amazon.Ags.Constants {
	...
	public partial class OverlayActionCode : global::Java.Lang.Object {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.ags.constants']/class[@name='OverlayActionCode']/field[@name='SHOW_ACHIEVEMENT_SIGN_IN_PROMPT']"
		[Register ("SHOW_ACHIEVEMENT_SIGN_IN_PROMPT")]
		public const string ShowAchievementSignInPrompt = (string) "SHOW_ACHIEVEMENT_SIGN_IN_PROMPT";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.ags.constants']/class[@name='OverlayActionCode']/field[@name='SHOW_LEADERBOARD_RANKS']"
		[Register ("SHOW_LEADERBOARD_RANKS")]
		public const int ShowLeaderboardRanks = (int) 6;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.ags.constants']/class[@name='OverlayActionCode']/field[@name='SHOW_LEADERBOARD_SIGN_IN_PROMPT']"
		[Register ("SHOW_LEADERBOARD_SIGN_IN_PROMPT")]
		public const string ShowLeaderboardSignInPrompt = (string) "SHOW_LEADERBOARD_SIGN_IN_PROMPT";
