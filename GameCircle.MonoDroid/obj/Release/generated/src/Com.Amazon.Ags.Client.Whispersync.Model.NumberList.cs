...
namespace Com.Amazon.Ags.Client.Whispersync.Model {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']"
	[global::Android.Runtime.Register ("com/amazon/ags/client/whispersync/model/NumberList", DoNotGenerateAcw=true)]
	public abstract partial class NumberList : global::Java.Lang.Object, global::Com.Amazon.Ags.Api.Whispersync.Model.ISyncableNumberList, global::Com.Amazon.Ags.Client.Whispersync.Model.IMergeable {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/field[@name='elements']"
		[Register ("elements")]
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/field[@name='name']"
		[Register ("name")]
		...
		public static class InterfaceConsts {
			...
			// The following are fields from: com.amazon.ags.api.whispersync.model.SyncableNumberList
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/ags/client/whispersync/model/NumberList", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (NumberList); }
		}

		protected NumberList (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/constructor[@name='NumberList' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public NumberList (string p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			IntPtr native_p0 = JNIEnv.NewString (p0);;
			if (GetType () != typeof (NumberList)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/constructor[@name='NumberList' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.util.List'] and parameter[3][@type='int'] and parameter[4][@type='com.amazon.ags.client.whispersync.model.SyncState']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/util/List;ILcom/amazon/ags/client/whispersync/model/SyncState;)V", "")]
		public NumberList (string p0, global::System.Collections.Generic.IList<global::Com.Amazon.Ags.Client.Whispersync.Model.NumberElement> p1, int p2, global::Com.Amazon.Ags.Client.Whispersync.Model.SyncState p3) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Ags.Client.Whispersync.Model.NumberList __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Client.Whispersync.Model.NumberList> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.Comparator);
		}
#pragma warning restore 0169

		public abstract global::Java.Util.IComparator Comparator {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='getComparator' and count(parameter)=0]"
			[Register ("getComparator", "()Ljava/util/Comparator;", "GetGetComparatorHandler")] get;
		}
...
#pragma warning restore 0169
		...
		public virtual bool IsSet {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='isSet' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual int MaxSize {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='getMaxSize' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='setMaxSize' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual global::Com.Amazon.Ags.Client.Whispersync.Model.SyncState State {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='getState' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public abstract global::Com.Amazon.Ags.Client.Whispersync.Model.SyncableType SyncableType {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='getSyncableType' and count(parameter)=0]"
			[Register ("getSyncableType", "()Lcom/amazon/ags/client/whispersync/model/SyncableType;", "GetGetSyncableTypeHandler")] get;
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='add' and count(parameter)=1 and parameter[1][@type='double']]"
...
#pragma warning restore 0169
		...
		static IntPtr id_add_DLjava_util_Map_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='add' and count(parameter)=2 and parameter[1][@type='double'] and parameter[2][@type='java.util.Map']]"
		[Register ("add", "(DLjava/util/Map;)V", "GetAdd_DLjava_util_Map_Handler")]
		public virtual void Add (double p0, global::System.Collections.Generic.IDictionary<string, string> p1)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_add_DLjava_util_Map_, new JValue (p0), new JValue (Java.Interop.JavaObjectExtensions.ToInteroperableCollection (p1)));
			JNIEnv.DeleteLocalRef (native_p1);
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='add' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("add", "(I)V", "GetAdd_IHandler")]
		public virtual void Add (int p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_add_I, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_add_ILjava_util_Map_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='add' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.util.Map']]"
		[Register ("add", "(ILjava/util/Map;)V", "GetAdd_ILjava_util_Map_Handler")]
		public virtual void Add (int p0, global::System.Collections.Generic.IDictionary<string, string> p1)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_add_ILjava_util_Map_, new JValue (p0), new JValue (Java.Interop.JavaObjectExtensions.ToInteroperableCollection (p1)));
			JNIEnv.DeleteLocalRef (native_p1);
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='add' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='add' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.util.Map']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='add' and count(parameter)=1 and parameter[1][@type='long']]"
		[Register ("add", "(J)V", "GetAdd_JHandler")]
		public virtual void Add (long p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_add_J, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_add_JLjava_util_Map_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='add' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='java.util.Map']]"
		[Register ("add", "(JLjava/util/Map;)V", "GetAdd_JLjava_util_Map_Handler")]
		public virtual void Add (long p0, global::System.Collections.Generic.IDictionary<string, string> p1)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_add_JLjava_util_Map_, new JValue (p0), new JValue (Java.Interop.JavaObjectExtensions.ToInteroperableCollection (p1)));
			JNIEnv.DeleteLocalRef (native_p1);
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='completeSyncing' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Ags.Client.Whispersync.Model.NumberList __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Client.Whispersync.Model.NumberList> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return global::Android.Runtime.JavaList<global::Com.Amazon.Ags.Client.Whispersync.Model.NumberElement>.ToLocalJniHandle (__this.CopyElements ());
		}
#pragma warning restore 0169

		static IntPtr id_copyElements;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='copyElements' and count(parameter)=0]"
		[Register ("copyElements", "()Ljava/util/List;", "GetCopyElementsHandler")]
		public virtual global::System.Collections.Generic.IList<global::Com.Amazon.Ags.Client.Whispersync.Model.NumberElement> CopyElements ()
		{
			if (id_copyElements == IntPtr.Zero)
				id_copyElements = JNIEnv.GetMethodID (class_ref, "copyElements", "()Ljava/util/List;");

			if (GetType () == ThresholdType)
				return global::Android.Runtime.JavaList<global::Com.Amazon.Ags.Client.Whispersync.Model.NumberElement>.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_copyElements), JniHandleOwnership.TransferLocalRef);
			else
				return global::Android.Runtime.JavaList<global::Com.Amazon.Ags.Client.Whispersync.Model.NumberElement>.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, id_copyElements), JniHandleOwnership.TransferLocalRef);
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='getValues' and count(parameter)=0]"
		[Register ("getValues", "()[Lcom/amazon/ags/api/whispersync/model/SyncableNumberElement;", "GetGetValuesHandler")]
		public virtual global::Com.Amazon.Ags.Api.Whispersync.Model.ISyncableNumberElement[] GetValues ()
		{
			...
			if (GetType () == ThresholdType)
				...
				return (global::Com.Amazon.Ags.Api.Whispersync.Model.ISyncableNumberElement[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, id_getValues), JniHandleOwnership.TransferLocalRef, typeof (global::Com.Amazon.Ags.Api.Whispersync.Model.ISyncableNumberElement));
		}

		static Delegate cb_merge_Lcom_amazon_ags_client_whispersync_model_NumberList_;
#pragma warning disable 0169
		static Delegate GetMerge_Lcom_amazon_ags_client_whispersync_model_NumberList_Handler ()
		{
			if (cb_merge_Lcom_amazon_ags_client_whispersync_model_NumberList_ == null)
				cb_merge_Lcom_amazon_ags_client_whispersync_model_NumberList_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_Merge_Lcom_amazon_ags_client_whispersync_model_NumberList_);
			return cb_merge_Lcom_amazon_ags_client_whispersync_model_NumberList_;
		}

		static void n_Merge_Lcom_amazon_ags_client_whispersync_model_NumberList_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Com.Amazon.Ags.Client.Whispersync.Model.NumberList __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Client.Whispersync.Model.NumberList> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Com.Amazon.Ags.Client.Whispersync.Model.NumberList p0 = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Client.Whispersync.Model.NumberList> (native_p0, JniHandleOwnership.DoNotTransfer);
			__this.Merge (p0);
		}
#pragma warning restore 0169

		static IntPtr id_merge_Lcom_amazon_ags_client_whispersync_model_NumberList_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='merge' and count(parameter)=1 and parameter[1][@type='com.amazon.ags.client.whispersync.model.NumberList']]"
		[Register ("merge", "(Lcom/amazon/ags/client/whispersync/model/NumberList;)V", "GetMerge_Lcom_amazon_ags_client_whispersync_model_NumberList_Handler")]
		public virtual void Merge (global::Com.Amazon.Ags.Client.Whispersync.Model.NumberList p0)
		{
			if (id_merge_Lcom_amazon_ags_client_whispersync_model_NumberList_ == IntPtr.Zero)
				id_merge_Lcom_amazon_ags_client_whispersync_model_NumberList_ = JNIEnv.GetMethodID (class_ref, "merge", "(Lcom/amazon/ags/client/whispersync/model/NumberList;)V");

			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_merge_Lcom_amazon_ags_client_whispersync_model_NumberList_, new JValue (p0));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_merge_Lcom_amazon_ags_client_whispersync_model_NumberList_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='NumberList']/method[@name='startSyncing' and count(parameter)=0]"
		...
		{
			Merge (global::Java.Interop.JavaObjectExtensions.JavaCast<Com.Amazon.Ags.Client.Whispersync.Model.NumberList>(p0));
		}

	}

	[global::Android.Runtime.Register ("com/amazon/ags/client/whispersync/model/NumberList", DoNotGenerateAcw=true)]
	internal partial class NumberListInvoker : NumberList, global::Com.Amazon.Ags.Client.Whispersync.Model.IMergeable {

		public NumberListInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		protected override global::System.Type ThresholdType {
			get { return typeof (NumberListInvoker); }
		}
