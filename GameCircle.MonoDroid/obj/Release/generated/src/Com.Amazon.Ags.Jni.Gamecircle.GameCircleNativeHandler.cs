...
namespace Com.Amazon.Ags.Jni.Gamecircle {
	...
	public partial class GameCircleNativeHandler : global::Java.Lang.Object {
		...
		static IntPtr id_showSignInPage_IJ;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.jni.gamecircle']/class[@name='GameCircleNativeHandler']/method[@name='showSignInPage' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='long']]"
		[Register ("showSignInPage", "(IJ)V", "")]
		public static void ShowSignInPage (int p0, long p1)
		{
			if (id_showSignInPage_IJ == IntPtr.Zero)
				id_showSignInPage_IJ = JNIEnv.GetStaticMethodID (class_ref, "showSignInPage", "(IJ)V");
			JNIEnv.CallStaticVoidMethod  (class_ref, id_showSignInPage_IJ, new JValue (p0), new JValue (p1));
		}

		static IntPtr id_showSignInPageHandle_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.jni.gamecircle']/class[@name='GameCircleNativeHandler']/method[@name='showSignInPageHandle' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("showSignInPageHandle", "(I)Lcom/amazon/ags/api/AGResponseHandle;", "")]
		public static global::Com.Amazon.Ags.Api.IAGResponseHandle ShowSignInPageHandle (int p0)
		{
			if (id_showSignInPageHandle_I == IntPtr.Zero)
				id_showSignInPageHandle_I = JNIEnv.GetStaticMethodID (class_ref, "showSignInPageHandle", "(I)Lcom/amazon/ags/api/AGResponseHandle;");
			return global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Api.IAGResponseHandle> (JNIEnv.CallStaticObjectMethod  (class_ref, id_showSignInPageHandle_I, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
		}
