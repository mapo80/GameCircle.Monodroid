...
namespace Com.Amazon.Ags.Client.Whispersync.Model {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']"
	[global::Android.Runtime.Register ("com/amazon/ags/client/whispersync/model/LowestNumber", DoNotGenerateAcw=true)]
	public partial class LowestNumber : global::Com.Amazon.Ags.Client.Whispersync.Model.NumberElement, global::Com.Amazon.Ags.Api.Whispersync.Model.ISyncableNumber, global::Com.Amazon.Ags.Client.Whispersync.Model.IMergeable {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/ags/client/whispersync/model/LowestNumber", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (LowestNumber); }
		}

		protected LowestNumber (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}
		...
		public LowestNumber (string p0, global::Java.Math.BigDecimal p1, global::System.Collections.Generic.IDictionary<string, string> p2, long p3, global::Com.Amazon.Ags.Client.Whispersync.Model.SyncState p4) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			if (GetType () != typeof (LowestNumber)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/constructor[@name='LowestNumber' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public LowestNumber (string p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Ags.Client.Whispersync.Model.LowestNumber __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Client.Whispersync.Model.LowestNumber> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.IsSet;
		}
#pragma warning restore 0169
		...
		public virtual bool IsSet {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='isSet' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual global::Com.Amazon.Ags.Client.Whispersync.Model.SyncState State {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='getState' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='completeSyncing' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='deepCopy' and count(parameter)=0]"
		[Register ("deepCopy", "()Lcom/amazon/ags/client/whispersync/model/LowestNumber;", "GetDeepCopyHandler")]
		public virtual global::Com.Amazon.Ags.Client.Whispersync.Model.LowestNumber DeepCopy ()
		{
			if (id_deepCopy == IntPtr.Zero)
				id_deepCopy = JNIEnv.GetMethodID (class_ref, "deepCopy", "()Lcom/amazon/ags/client/whispersync/model/LowestNumber;");

			if (GetType () == ThresholdType)
				return global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Client.Whispersync.Model.LowestNumber> (JNIEnv.CallObjectMethod  (Handle, id_deepCopy), JniHandleOwnership.TransferLocalRef);
			else
				return global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Client.Whispersync.Model.LowestNumber> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, id_deepCopy), JniHandleOwnership.TransferLocalRef);
		}

		static Delegate cb_merge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_;
#pragma warning disable 0169
		static Delegate GetMerge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_Handler ()
		{
			if (cb_merge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_ == null)
				cb_merge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_Merge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_);
			return cb_merge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_;
		}

		static void n_Merge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Com.Amazon.Ags.Client.Whispersync.Model.LowestNumber __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Client.Whispersync.Model.LowestNumber> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Com.Amazon.Ags.Client.Whispersync.Model.LowestNumber p0 = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Client.Whispersync.Model.LowestNumber> (native_p0, JniHandleOwnership.DoNotTransfer);
			__this.Merge (p0);
		}
#pragma warning restore 0169

		static IntPtr id_merge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='merge' and count(parameter)=1 and parameter[1][@type='com.amazon.ags.client.whispersync.model.LowestNumber']]"
		[Register ("merge", "(Lcom/amazon/ags/client/whispersync/model/LowestNumber;)V", "GetMerge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_Handler")]
		public virtual void Merge (global::Com.Amazon.Ags.Client.Whispersync.Model.LowestNumber p0)
		{
			if (id_merge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_ == IntPtr.Zero)
				id_merge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_ = JNIEnv.GetMethodID (class_ref, "merge", "(Lcom/amazon/ags/client/whispersync/model/LowestNumber;)V");

			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_merge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_, new JValue (p0));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_merge_Lcom_amazon_ags_client_whispersync_model_LowestNumber_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='set' and count(parameter)=1 and parameter[1][@type='double']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='set' and count(parameter)=2 and parameter[1][@type='double'] and parameter[2][@type='java.util.Map']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='set' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='set' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.util.Map']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='set' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='set' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.util.Map']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='set' and count(parameter)=1 and parameter[1][@type='long']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='set' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='java.util.Map']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='LowestNumber']/method[@name='startSyncing' and count(parameter)=0]"
		...
		{
			Merge (global::Java.Interop.JavaObjectExtensions.JavaCast<Com.Amazon.Ags.Client.Whispersync.Model.LowestNumber>(p0));
		}
