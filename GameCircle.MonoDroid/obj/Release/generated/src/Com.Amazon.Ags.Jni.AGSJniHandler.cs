...
namespace Com.Amazon.Ags.Jni {
	...
	public partial class AGSJniHandler : global::Java.Lang.Object {
		...
		static IntPtr id_showSignInPageResponseFailure_JII;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.jni']/class[@name='AGSJniHandler']/method[@name='showSignInPageResponseFailure' and count(parameter)=3 and parameter[1][@type='long'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		[Register ("showSignInPageResponseFailure", "(JII)V", "")]
		public static void ShowSignInPageResponseFailure (long p0, int p1, int p2)
		{
			if (id_showSignInPageResponseFailure_JII == IntPtr.Zero)
				id_showSignInPageResponseFailure_JII = JNIEnv.GetStaticMethodID (class_ref, "showSignInPageResponseFailure", "(JII)V");
			JNIEnv.CallStaticVoidMethod  (class_ref, id_showSignInPageResponseFailure_JII, new JValue (p0), new JValue (p1), new JValue (p2));
		}

		static IntPtr id_showSignInPageResponseSuccess_JI;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.jni']/class[@name='AGSJniHandler']/method[@name='showSignInPageResponseSuccess' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='int']]"
		[Register ("showSignInPageResponseSuccess", "(JI)V", "")]
		public static void ShowSignInPageResponseSuccess (long p0, int p1)
		{
			if (id_showSignInPageResponseSuccess_JI == IntPtr.Zero)
				id_showSignInPageResponseSuccess_JI = JNIEnv.GetStaticMethodID (class_ref, "showSignInPageResponseSuccess", "(JI)V");
			JNIEnv.CallStaticVoidMethod  (class_ref, id_showSignInPageResponseSuccess_JI, new JValue (p0), new JValue (p1));
		}
