...
namespace Com.Amazon.Ags.Jni.Gamecircle {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.ags.jni.gamecircle']/class[@name='ShowSignInPageJniRespHandler']"
	[global::Android.Runtime.Register ("com/amazon/ags/jni/gamecircle/ShowSignInPageJniRespHandler", DoNotGenerateAcw=true)]
	public partial class ShowSignInPageJniRespHandler : global::Com.Amazon.Ags.Jni.JniResponseHandler, global::Com.Amazon.Ags.Api.IAGResponseCallback {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/ags/jni/gamecircle/ShowSignInPageJniRespHandler", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ShowSignInPageJniRespHandler); }
		}

		protected ShowSignInPageJniRespHandler (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_IJ;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.ags.jni.gamecircle']/class[@name='ShowSignInPageJniRespHandler']/constructor[@name='ShowSignInPageJniRespHandler' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='long']]"
		[Register (".ctor", "(IJ)V", "")]
		public ShowSignInPageJniRespHandler (int p0, long p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (ShowSignInPageJniRespHandler)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Ags.Jni.Gamecircle.ShowSignInPageJniRespHandler __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Jni.Gamecircle.ShowSignInPageJniRespHandler> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.jni.gamecircle']/class[@name='ShowSignInPageJniRespHandler']/method[@name='onComplete' and count(parameter)=1 and parameter[1][@type='com.amazon.ags.api.RequestResponse']]"
