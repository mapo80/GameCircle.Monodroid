...
#pragma warning restore 0169
		...
		static Delegate cb_loadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_;
#pragma warning disable 0169
		static Delegate GetLoadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_Handler ()
		{
			if (cb_loadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_ == null)
				cb_loadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_LoadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_);
			return cb_loadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_;
		}

		static void n_LoadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Com.Amazon.Ags.Html5.Content.GCVariationManager __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Html5.Content.GCVariationManager> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Com.Amazon.Ags.Storage.IOfflineDataCache p0 = (global::Com.Amazon.Ags.Storage.IOfflineDataCache)global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Storage.IOfflineDataCache> (native_p0, JniHandleOwnership.DoNotTransfer);
			__this.LoadVariationsFromSQLite (p0);
		}
#pragma warning restore 0169

		static IntPtr id_loadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.html5.content']/class[@name='GCVariationManager']/method[@name='loadVariationsFromSQLite' and count(parameter)=1 and parameter[1][@type='com.amazon.ags.storage.OfflineDataCache']]"
		[Register ("loadVariationsFromSQLite", "(Lcom/amazon/ags/storage/OfflineDataCache;)V", "GetLoadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_Handler")]
		public virtual void LoadVariationsFromSQLite (global::Com.Amazon.Ags.Storage.IOfflineDataCache p0)
		{
			if (id_loadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_ == IntPtr.Zero)
				id_loadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_ = JNIEnv.GetMethodID (class_ref, "loadVariationsFromSQLite", "(Lcom/amazon/ags/storage/OfflineDataCache;)V");

			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_loadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_, new JValue (p0));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_loadVariationsFromSQLite_Lcom_amazon_ags_storage_OfflineDataCache_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		static Delegate cb_saveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_;
#pragma warning disable 0169
		static Delegate GetSaveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_Handler ()
		{
			if (cb_saveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_ == null)
				cb_saveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_SaveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_);
			return cb_saveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_;
		}

		static void n_SaveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Com.Amazon.Ags.Html5.Content.GCVariationManager __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Html5.Content.GCVariationManager> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Com.Amazon.Ags.Storage.IOfflineDataCache p0 = (global::Com.Amazon.Ags.Storage.IOfflineDataCache)global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Storage.IOfflineDataCache> (native_p0, JniHandleOwnership.DoNotTransfer);
			__this.SaveVariationsToSQLite (p0);
		}
#pragma warning restore 0169

		static IntPtr id_saveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.html5.content']/class[@name='GCVariationManager']/method[@name='saveVariationsToSQLite' and count(parameter)=1 and parameter[1][@type='com.amazon.ags.storage.OfflineDataCache']]"
		[Register ("saveVariationsToSQLite", "(Lcom/amazon/ags/storage/OfflineDataCache;)V", "GetSaveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_Handler")]
		public virtual void SaveVariationsToSQLite (global::Com.Amazon.Ags.Storage.IOfflineDataCache p0)
		{
			if (id_saveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_ == IntPtr.Zero)
				id_saveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_ = JNIEnv.GetMethodID (class_ref, "saveVariationsToSQLite", "(Lcom/amazon/ags/storage/OfflineDataCache;)V");

			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_saveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_, new JValue (p0));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_saveVariationsToSQLite_Lcom_amazon_ags_storage_OfflineDataCache_, new JValue (p0));
		}
