...
namespace Com.Amazon.Ags.Client.Whispersync.Model {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='HighNumberList']"
	[global::Android.Runtime.Register ("com/amazon/ags/client/whispersync/model/HighNumberList", DoNotGenerateAcw=true)]
	public partial class HighNumberList : global::Com.Amazon.Ags.Client.Whispersync.Model.NumberList {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/ags/client/whispersync/model/HighNumberList", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (HighNumberList); }
		}

		protected HighNumberList (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='HighNumberList']/constructor[@name='HighNumberList' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public HighNumberList (string p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			IntPtr native_p0 = JNIEnv.NewString (p0);;
			if (GetType () != typeof (HighNumberList)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='HighNumberList']/constructor[@name='HighNumberList' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.util.List'] and parameter[3][@type='int'] and parameter[4][@type='com.amazon.ags.client.whispersync.model.SyncState']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/util/List;ILcom/amazon/ags/client/whispersync/model/SyncState;)V", "")]
		public HighNumberList (string p0, global::System.Collections.Generic.IList<global::Com.Amazon.Ags.Client.Whispersync.Model.NumberElement> p1, int p2, global::Com.Amazon.Ags.Client.Whispersync.Model.SyncState p3) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Ags.Client.Whispersync.Model.HighNumberList __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Ags.Client.Whispersync.Model.HighNumberList> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public override global::Java.Util.IComparator Comparator {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='HighNumberList']/method[@name='getComparator' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override global::Com.Amazon.Ags.Client.Whispersync.Model.SyncableType SyncableType {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='HighNumberList']/method[@name='getSyncableType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.ags.client.whispersync.model']/class[@name='HighNumberList']/method[@name='deepCopy' and count(parameter)=0]"
