...
namespace Com.Amazon.Ags.Client.Whispersync.Marshaller {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.ags.client.whispersync.marshaller']/class[@name='ParseException']"
	[global::Android.Runtime.Register ("com/amazon/ags/client/whispersync/marshaller/ParseException", DoNotGenerateAcw=true)]
	public partial class ParseException : global::Java.Lang.Exception {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/ags/client/whispersync/marshaller/ParseException", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.ags.client.whispersync.marshaller']/class[@name='ParseException']/constructor[@name='ParseException' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public ParseException () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.ags.client.whispersync.marshaller']/class[@name='ParseException']/constructor[@name='ParseException' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/Throwable;)V", "")]
		public ParseException (string p0, global::Java.Lang.Throwable p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.ags.client.whispersync.marshaller']/class[@name='ParseException']/constructor[@name='ParseException' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.ags.client.whispersync.marshaller']/class[@name='ParseException']/constructor[@name='ParseException' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/Throwable;)V", "")]
		public ParseException (global::Java.Lang.Throwable p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
