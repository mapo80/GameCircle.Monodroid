...
namespace Com.Amazon.Insights.Error {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.insights.error']/class[@name='NullArgumentError']"
	[global::Android.Runtime.Register ("com/amazon/insights/error/NullArgumentError", DoNotGenerateAcw=true)]
	public partial class NullArgumentError : global::Com.Amazon.Insights.Error.BaseInsightsError {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/insights/error/NullArgumentError", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (NullArgumentError); }
		}

		protected NullArgumentError (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.insights.error']/class[@name='NullArgumentError']/constructor[@name='NullArgumentError' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;)V", "")]
		public NullArgumentError (string p0, string p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			if (GetType () != typeof (NullArgumentError)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Insights.Error.NullArgumentError __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Insights.Error.NullArgumentError> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public override string Message {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights.error']/class[@name='NullArgumentError']/method[@name='getMessage' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string ParameterName {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights.error']/class[@name='NullArgumentError']/method[@name='getParameterName' and count(parameter)=0]"
