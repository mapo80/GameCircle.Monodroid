...
namespace Com.Amazon.Insights.Session.Client {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.insights.session.client']/class[@name='PausedSessionState']"
	[global::Android.Runtime.Register ("com/amazon/insights/session/client/PausedSessionState", DoNotGenerateAcw=true)]
	public partial class PausedSessionState : global::Com.Amazon.Insights.Session.Client.SessionClientState {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/insights/session/client/PausedSessionState", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (PausedSessionState); }
		}

		protected PausedSessionState (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_amazon_insights_session_client_DefaultSessionClient_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.insights.session.client']/class[@name='PausedSessionState']/constructor[@name='PausedSessionState' and count(parameter)=1 and parameter[1][@type='com.amazon.insights.session.client.DefaultSessionClient']]"
		[Register (".ctor", "(Lcom/amazon/insights/session/client/DefaultSessionClient;)V", "")]
		public PausedSessionState (global::Com.Amazon.Insights.Session.Client.DefaultSessionClient p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (PausedSessionState)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Insights.Session.Client.PausedSessionState __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Insights.Session.Client.PausedSessionState> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Pause ();
		}
#pragma warning restore 0169

		static IntPtr id_pause;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights.session.client']/class[@name='PausedSessionState']/method[@name='pause' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights.session.client']/class[@name='PausedSessionState']/method[@name='resume' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights.session.client']/class[@name='PausedSessionState']/method[@name='start' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights.session.client']/class[@name='PausedSessionState']/method[@name='stop' and count(parameter)=0]"
