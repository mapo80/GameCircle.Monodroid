...
namespace Com.Amazon.Insights {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.amazon.insights']/interface[@name='EventClient']"
	[Register ("com/amazon/insights/EventClient", "", "Com.Amazon.Insights.IEventClientInvoker")]
	public partial interface IEventClient : IJavaObject {

		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights']/interface[@name='EventClient']/method[@name='addGlobalAttribute' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		[Register ("addGlobalAttribute", "(Ljava/lang/String;Ljava/lang/String;)V", "GetAddGlobalAttribute_Ljava_lang_String_Ljava_lang_String_Handler:Com.Amazon.Insights.IEventClientInvoker, AmazonInsights.MonoDroid")]
		void AddGlobalAttribute (string p0, string p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights']/interface[@name='EventClient']/method[@name='addGlobalAttribute' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String']]"
		[Register ("addGlobalAttribute", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "GetAddGlobalAttribute_Ljava_lang_String_Ljava_lang_String_Ljava_lang_String_Handler:Com.Amazon.Insights.IEventClientInvoker, AmazonInsights.MonoDroid")]
		void AddGlobalAttribute (string p0, string p1, string p2);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights']/interface[@name='EventClient']/method[@name='addGlobalMetric' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Number']]"
		[Register ("addGlobalMetric", "(Ljava/lang/String;Ljava/lang/Number;)V", "GetAddGlobalMetric_Ljava_lang_String_Ljava_lang_Number_Handler:Com.Amazon.Insights.IEventClientInvoker, AmazonInsights.MonoDroid")]
		void AddGlobalMetric (string p0, global::Java.Lang.Number p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights']/interface[@name='EventClient']/method[@name='addGlobalMetric' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.Number']]"
		[Register ("addGlobalMetric", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Number;)V", "GetAddGlobalMetric_Ljava_lang_String_Ljava_lang_String_Ljava_lang_Number_Handler:Com.Amazon.Insights.IEventClientInvoker, AmazonInsights.MonoDroid")]
		void AddGlobalMetric (string p0, string p1, global::Java.Lang.Number p2);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights']/interface[@name='EventClient']/method[@name='createEvent' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("createEvent", "(Ljava/lang/String;)Lcom/amazon/insights/Event;", "GetCreateEvent_Ljava_lang_String_Handler:Com.Amazon.Insights.IEventClientInvoker, AmazonInsights.MonoDroid")]
		global::Com.Amazon.Insights.IEvent CreateEvent (string p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights']/interface[@name='EventClient']/method[@name='recordEvent' and count(parameter)=1 and parameter[1][@type='com.amazon.insights.Event']]"
		[Register ("recordEvent", "(Lcom/amazon/insights/Event;)V", "GetRecordEvent_Lcom_amazon_insights_Event_Handler:Com.Amazon.Insights.IEventClientInvoker, AmazonInsights.MonoDroid")]
		void RecordEvent (global::Com.Amazon.Insights.IEvent p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights']/interface[@name='EventClient']/method[@name='removeGlobalAttribute' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("removeGlobalAttribute", "(Ljava/lang/String;)V", "GetRemoveGlobalAttribute_Ljava_lang_String_Handler:Com.Amazon.Insights.IEventClientInvoker, AmazonInsights.MonoDroid")]
		void RemoveGlobalAttribute (string p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights']/interface[@name='EventClient']/method[@name='removeGlobalAttribute' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		[Register ("removeGlobalAttribute", "(Ljava/lang/String;Ljava/lang/String;)V", "GetRemoveGlobalAttribute_Ljava_lang_String_Ljava_lang_String_Handler:Com.Amazon.Insights.IEventClientInvoker, AmazonInsights.MonoDroid")]
		void RemoveGlobalAttribute (string p0, string p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights']/interface[@name='EventClient']/method[@name='removeGlobalMetric' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("removeGlobalMetric", "(Ljava/lang/String;)V", "GetRemoveGlobalMetric_Ljava_lang_String_Handler:Com.Amazon.Insights.IEventClientInvoker, AmazonInsights.MonoDroid")]
		void RemoveGlobalMetric (string p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights']/interface[@name='EventClient']/method[@name='removeGlobalMetric' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		[Register ("removeGlobalMetric", "(Ljava/lang/String;Ljava/lang/String;)V", "GetRemoveGlobalMetric_Ljava_lang_String_Ljava_lang_String_Handler:Com.Amazon.Insights.IEventClientInvoker, AmazonInsights.MonoDroid")]
		void RemoveGlobalMetric (string p0, string p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.insights']/interface[@name='EventClient']/method[@name='submitEvents' and count(parameter)=0]"
		[Register ("submitEvents", "()V", "GetSubmitEventsHandler:Com.Amazon.Insights.IEventClientInvoker, AmazonInsights.MonoDroid")]
		void SubmitEvents ();

	}

	[global::Android.Runtime.Register ("com/amazon/insights/EventClient", DoNotGenerateAcw=true)]
	internal class IEventClientInvoker : global::Java.Lang.Object, IEventClient {

		static IntPtr java_class_ref = JNIEnv.FindClass ("com/amazon/insights/EventClient");
		IntPtr class_ref;

		public static IEventClient GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IEventClient> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.amazon.insights.EventClient"));
			return handle;
		}
		...
		public IEventClientInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
		...
		protected override System.Type ThresholdType {
			get { return typeof (IEventClientInvoker); }
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Insights.IEventClient __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Insights.IEventClient> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
