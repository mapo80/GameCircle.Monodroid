...
namespace Com.Amazon.Insights.Session.Client {
	...
	public partial class DefaultSessionClient : global::Java.Lang.Object, global::sessionImpl.IInternalSessionClient {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.insights.session.client']/class[@name='DefaultSessionClient']/field[@name='SESSION_START_TIME_ATTRIBUTE_KEY']"
		[Register ("SESSION_START_TIME_ATTRIBUTE_KEY")]
		public const string SessionStartTimeAttributeKey = (string) "_session.startTime";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.insights.session.client']/class[@name='DefaultSessionClient']/field[@name='SESSION_STOP_TIME_ATTRIBUTE_KEY']"
		[Register ("SESSION_STOP_TIME_ATTRIBUTE_KEY")]
		public const string SessionStopTimeAttributeKey = (string) "_session.stopTime";
