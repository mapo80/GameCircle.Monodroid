...
namespace Com.Amazon.Identity.Auth.Device.Authorization {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.identity.auth.device.authorization']/class[@name='ThirdPartyAuthorizationServiceConnection']"
	[global::Android.Runtime.Register ("com/amazon/identity/auth/device/authorization/ThirdPartyAuthorizationServiceConnection", DoNotGenerateAcw=true)]
	public partial class ThirdPartyAuthorizationServiceConnection : global::Com.Amazon.Identity.Auth.Device.Authorization.MAPServiceConnection {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/identity/auth/device/authorization/ThirdPartyAuthorizationServiceConnection", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ThirdPartyAuthorizationServiceConnection); }
		}

		protected ThirdPartyAuthorizationServiceConnection (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.identity.auth.device.authorization']/class[@name='ThirdPartyAuthorizationServiceConnection']/constructor[@name='ThirdPartyAuthorizationServiceConnection' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public ThirdPartyAuthorizationServiceConnection () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (ThirdPartyAuthorizationServiceConnection)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Identity.Auth.Device.Authorization.ThirdPartyAuthorizationServiceConnection __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Identity.Auth.Device.Authorization.ThirdPartyAuthorizationServiceConnection> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public override global::Java.Lang.Class ServiceInterfaceClass {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.identity.auth.device.authorization']/class[@name='ThirdPartyAuthorizationServiceConnection']/method[@name='getServiceInterfaceClass' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.identity.auth.device.authorization']/class[@name='ThirdPartyAuthorizationServiceConnection']/method[@name='getServiceInterface' and count(parameter)=1 and parameter[1][@type='android.os.IBinder']]"
